...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__material_base_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__material_ripple_index__ = __webpack_require__(6);
...
var autoInit = function autoInit() {
  ...
  var containers = [_drawer.DrawerContainer, _textfield.TextFieldContainer, _textfieldHelperText.TextFieldHelperTextContainer, _button.ButtonContainer, _topAppBar.TopAppBarContainer, _snackbar.SnackbarContainer, _ripple.RippleContainer, _select.SelectContainer];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__material_ripple_index__ = __webpack_require__(6);
...
exports.RippleContainer = exports.Ripple = undefined;
 ...
 * @return {Object}
 */
var RippleContainer = function RippleContainer() {
  return {
    selector: '.mdc-ripple-surface',
    init: function init(element) {
      return _Ripple2.default.render(element);
    }
  };
};
...
exports.MDCAutocompleteContainer = exports.MDCAutocomplete = undefined;
 ...
 * @return {Object}
 */
var MDCAutocompleteContainer = function MDCAutocompleteContainer() {
  return {
...
exports.MDCAutocomplete = _Autocomplete2.default;
exports.MDCAutocompleteContainer = MDCAutocompleteContainer;
...
var _crossFetch = __webpack_require__(72);

var _crossFetch2 = _interopRequireDefault(_crossFetch);

var _api = __webpack_require__(73);

var _linearProgress = __webpack_require__(74);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var MDCAutocomplete = function () {
  _createClass(MDCAutocomplete, null, [{
    key: 'clear',
  ...
  function MDCAutocomplete(props) {
    _classCallCheck(this, MDCAutocomplete);

    if (!props.element) {
      throw new Error('Please, provide an element (`.mdc-autocomplete`)');
    }
    var textfield = props.element.querySelector('.' + MDCAutocomplete.classes['TEXTFIELD']);
    var results = props.element.querySelector('.' + MDCAutocomplete.classes['RESULTS']);
    var chips = props.element.querySelector('.' + MDCAutocomplete.classes['CHIPS']);
    var isMultiple = props.element.classList.contains(MDCAutocomplete.classes['IS_MULTIPLE']);
  ...
  _createClass(MDCAutocomplete, [{
    ...
    value: function updateSelected() {
      var items = this.state.elements.results.querySelectorAll('.' + MDCAutocomplete.classes.LIST_ITEM);
      var chips = this.state.elements.chips.querySelectorAll('input');

      for (var i = 0; i < items.length; i++) {
        var key = items[i].dataset[MDCAutocomplete.datasets.KEY];
        var isSelected = this.state.elements.chips.querySelector('input[value="' + key + '"]');
    ...
    key: 'onCancelChip',
    value: function onCancelChip(event) {
    ...
    value: function addChip(text, value) {
      ...
      var chip = MDCAutocomplete.create({
        tag: 'div',
        classes: [MDCAutocomplete.classes['MDC_CHIP']]
      });
      // Criando o elemento de texto do chip.
      var chipText = MDCAutocomplete.create({
        tag: 'div',
        text: text,
        classes: [MDCAutocomplete.classes['MDC_CHIP_TEXT']]
      });
      // Adiciona o texto no chip. 
      chip.appendChild(chipText);
      // Criando o botão para remover o chip.
      var chipCancel = MDCAutocomplete.create({
        tag: 'i',
        text: MDCAutocomplete.constants['MATERIAL_ICON_CANCEL'],
        classes: [MDCAutocomplete.classes['MATERIAL_ICONS'], MDCAutocomplete.classes['MDC_CHIP_ICON'], MDCAutocomplete.classes['MDC_CHIP_ICON_TRAILING']],
        attributes: [{
          name: 'role',
          value: 'button'
        }, {
      ...
      var input = MDCAutocomplete.create({
        tag: 'input',
        attributes: [{
          name: 'type',
          value: 'hidden'
    ...
    value: function onSearchResultSelect(event) {
      ...
      var value = event.target.dataset[MDCAutocomplete.datasets['KEY']];
    ...
    value: function onSearchSuccess(data, query) {
      ...
      });var list = MDCAutocomplete.create({
        tag: 'ul',
        classes: [MDCAutocomplete.classes['LIST'], MDCAutocomplete.classes['MDC_LIST']],
        attributes: [{
          name: 'role',
          value: 'menu'
        }, {
      ...
      for (var i = 0; i < this.state.results.length; i++) {
        ...
        var item = MDCAutocomplete.create({
          tag: 'li',
          text: this.state.results[i]['text'],
          classes: [MDCAutocomplete.classes['LIST_ITEM'], MDCAutocomplete.classes['MDC_LIST_ITEM']],
          attributes: [{
            name: 'tabindex',
            value: '-1'
          }],
    ...
    value: function onSearch(query) {
      ...
      params.set(this.state.queryParam || MDCAutocomplete.constants.QUERY_PARAM, query);
    ...
    value: function checkValidity() {
      ...
      var inputSearch = this.state.elements.textfield.querySelector('input');
      var inputs = this.state.elements.chips.querySelectorAll('input');

      if (!this.state.validate.check(inputs)) {
        inputSearch.setCustomValidity(this.state.validate.message || 'Campo inválido');
    ...
    key: 'componentWillSearch',
    value: function componentWillSearch(event) {
      var _this2 = this;
      ...
      return function (event) {
        // Usando tab.
        var preventedKeys = [9, 13, 16, 37, 38, 39, 40];

        if (!preventedKeys.includes(event.keyCode)) {
          // Limpa os resultados de busca.
          MDCAutocomplete.clear(_this2.state.elements.results);
        }
        clearTimeout(timer);
        timer = setTimeout(function () {
          return _this2.onSearch(event.target.value);
        }, _this2.state.delay);
      };
    }
    ...
    value: function onComponentKeyDown(event) {
      var input = this.state.elements.textfield.querySelector('input');
      var active = document.activeElement;
      var results = this.state.elements.results;
      ...
      if (event.keyCode === 13) {
        var isResultItem = results.contains(active);

        if (!isResultItem) {
          var isChip = this.state.elements.chips.contains(active);
      ...
      if (event.keyCode === 40) {
        ...
        if (input === active) {
          ...
          var firstItem = this.state.elements.results.querySelector('.' + MDCAutocomplete.classes.LIST_ITEM);
    ...
    value: function hydrate() {
      ...
      var values = this.state.elements.chips.querySelectorAll('.' + MDCAutocomplete.classes.MDC_CHIP);

      for (var i = 0; i < values.length; i++) {
        var cancelButton = values[i].querySelector('.' + MDCAutocomplete.classes.MDC_CHIP_ICON);
...
MDCAutocomplete.constants = {
  MATERIAL_ICON_CANCEL: 'cancel',
  QUERY_PARAM: 'q' };
MDCAutocomplete.classes = {
...
MDCAutocomplete.datasets = {
  KEY: 'MDCAutocompleteKey' };
exports.default = MDCAutocomplete;
...
var _LinearProgressGlobal = __webpack_require__(75);
...
exports.SelectContainer = exports.Select = undefined;
 ...
 * @return {Object}
 */
var SelectContainer = function SelectContainer() {
  return {
    selector: '.mdc-select',
    init: function init(element) {
      return _Select2.default.render(element);
    }
  };
};
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__material_base_index__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__material_floating_label_index__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__material_line_ripple_index__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__material_ripple_index__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__foundation__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__constants__ = __webpack_require__(81);
...
class MDCSelect extends __WEBPACK_IMPORTED_MODULE_0__material_base_index__["a" /* MDCComponent */] {
  ...
  initialize(
    ...
    const labelElement = this.root_.querySelector(__WEBPACK_IMPORTED_MODULE_5__constants__["b" /* strings */].LABEL_SELECTOR);
    if (labelElement) {
      this.label_ = labelFactory(labelElement);
    }
    const lineRippleElement = this.root_.querySelector(__WEBPACK_IMPORTED_MODULE_5__constants__["b" /* strings */].LINE_RIPPLE_SELECTOR);
    if (lineRippleElement) {
      this.lineRipple_ = lineRippleFactory(lineRippleElement);
    }
